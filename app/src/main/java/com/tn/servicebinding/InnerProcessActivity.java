...
public class InnerProcessActivity extends ActionBarActivity {
    ...
    protected void onStart() {
        super.onStart();
        Intent intent = new Intent(this, InnerProcessService.class);
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            Message msg = Message.obtain(null, InnerProcessService.OPERATION_START);
    ...
    private static class ServiceMessagesHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (reference != null) {
                switch (msg.what) {
                    case InnerProcessService.OPERATION_FINISHED:
